...
import { BackHandler, Image, LayoutChangeEvent, Platform, Pressable, StyleSheet, View } from "react-native";
...
import calendar_screen from "../screens/Calendar/calendar_screen";
...
export const BottomNavigationContainer = () => {
    ...
    //Property longtitude does not exist on type 'object
    return (
        <Tab.Navigator
        screenOptions={({route}) => ({
            headerShown: false,
