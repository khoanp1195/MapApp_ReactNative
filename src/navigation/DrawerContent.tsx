...
const DRAWER_SCENES: DrawerScene[] = [
  { label: 'Home', icon: AppImages.home_icon,  isAssetIcon: true ,routeKey: 'MainDrawer' },
  {
    label: 'Help',
  ...
  { label: 'Feedback', icon: AppImages.feedback_icon, isAssetIcon: true, routeKey: 'feedback' },
  { label: 'Invite Friend', icon: AppImages.invite_icon, isAssetIcon: true, routeKey: 'invite_friend' },
  { label: 'Rate the app', icon: AppImages.rateApp_icon, isAssetIcon: true, },
  { label: 'About Us', icon: AppImages.about_icon, isAssetIcon: true, },
];
...
> = props => {
  ...
  console.log("icon - drawer - here: " + icon)
